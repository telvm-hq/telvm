# Slackeel documentation

| Document | Description |
|----------|-------------|
| [OLLAMA.md](OLLAMA.md) | **Local inference:** Docker Compose, smoke scripts, **`model_doctor`**, API contract, quickstart |
| [../manifest/README.md](../manifest/README.md) | **`models.json`** manifest |
| [MODEL_CATALOG.md](MODEL_CATALOG.md) | Model families, Ollama names, approximate disk |
