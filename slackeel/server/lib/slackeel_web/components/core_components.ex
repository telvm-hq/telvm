defmodule SlackeelWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: SlackeelWeb.Gettext
  ...
  ## Examples
      ...
      <.button navigate={~p"/preflight"}>Pre-flight</.button>
  """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SlackeelWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SlackeelWeb.Gettext, "errors", msg, opts)
    end
  end
