...
help:
	@echo "Targets:"
	@echo "  smoke-closed-egress   Run scripts/closed-agent/verify-closed-agent-egress.sh (requires: docker compose up from repo root)"
...
smoke-closed-egress:
	@chmod +x scripts/closed-agent/verify-closed-agent-egress.sh 2>/dev/null || true
